...
public class DiscoveryServer(int port) : IServer
{
    /// <summary>
    /// Lock object
    /// </summary>
    ...
    /// </summary>
    public string Identity { get; set; } = "www.lightspeedsaber.com";
    ...
    public void Start()
    {
        lock (_lock)
        {
            ...
            _thread = new Thread(DiscoveryServerProc);
            _thread.Start();
        }
    }
    ...
    /// </summary>
    private void DiscoveryServerProc()
    {
        ...
        while (true)
        {
            ...
            if (_cancel is not null && _cancel.Token.WaitHandle.WaitOne(3000))
                break;
