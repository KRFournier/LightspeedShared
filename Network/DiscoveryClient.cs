...
public class DiscoveryClient(int port) : IClient
{
    /// <summary>
    /// Lock object
    /// </summary>
    ...
    public void Start()
    {
        lock (_lock)
        {
            ...
            _thread = new Thread(DiscoveryClientProc);
            _thread.Start();
        }
    }
    ...
    /// </summary>
    private void DiscoveryClientProc()
    {
        ...
        while (_cancel is not null && !_cancel.IsCancellationRequested)
        {
